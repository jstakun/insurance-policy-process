<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("taskPrice");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isNumeric(myInputs[j])) {
							alert("Please enter valid taskPrice");
							myInputs[j].focus();
							return false;
						}
	...
	<div id="content">
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		<label for="name">taskDriver</label>
                            		<div class="div_checkbox">
                              		${taskDriver}
                            		</div>
                            		<label for="name">taskPolicy</label>
                            		<div class="div_checkbox">
                              		${taskPolicy}
                            		</div>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">taskPrice</label>
                            		<div class="div_texbox">
                              		<input name="taskPrice" type="text" class="textbox" id="taskPrice" value="" />
                            		</div>
